...
function form($data){
	...
	<?=Helper::input($data, 'Batas Pinjam Buku', 'tgl_batas_pinjam', 'date'); ?>
	<?=Helper::input($data, 'Kembalikan Buku', 'tgl_kembali_buku', 'date'); ?>
	<input type="submit"  class="btn btn-primary" name="simpan" value="Simpan">
<a class="btn btn-primary" href="?modul=pinjam">Kembali</a>
	</form>
	<?php
}
